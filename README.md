...
| 🖼️ Nhập ảnh có sẵn | Thêm trang từ thư viện ảnh thay vì chụp mới |
| ✏️ Chỉnh sửa trang | Xoay, chỉnh độ sáng/tương phản, chuyển thang độ xám, có undo |
...
| 🖨️ Xuất ảnh | Xuất từng trang dưới dạng file ảnh riêng |

# Hướng dẫn Dev — Doc Scanner Android

> Đây là tài liệu dành cho lập trình viên muốn build/chạy dự án từ source. Nếu chỉ muốn
> tải app về dùng, xem [README chính](../README.md).
